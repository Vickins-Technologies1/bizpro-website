...
export function buttonStyles(variant: Variant = "primary", className?: string) {
  const base =
    "inline-flex min-h-11 items-center justify-center gap-2 rounded-full px-5 py-3 text-sm font-medium transition duration-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 focus-visible:ring-offset-background";
  ...
  const variants: Record<Variant, string> = {
    ...
    secondary:
      "border border-border/80 bg-card/85 text-foreground hover:border-primary/40 hover:bg-card",

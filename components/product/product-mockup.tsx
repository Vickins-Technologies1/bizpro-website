...
export function ProductMockup() {
  return (
    <div className="group relative isolate overflow-hidden rounded-[2rem] border border-border/70 bg-card/80 p-2.5 shadow-panel transition duration-300 motion-safe:animate-slide-up motion-safe:hover:-translate-y-1 motion-safe:hover:shadow-glow sm:p-3">
      ...
      <div className="relative grid gap-2.5 lg:grid-cols-[12.5rem_minmax(0,1fr)]">
        <aside className="rounded-[1.5rem] border border-border/70 bg-background/85 p-3.5">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-muted">Live store</p>
            </div>
          </div>
          ...
          <div className="mt-4 rounded-2xl border border-border/70 bg-card/70 p-2.5">
            <div className="flex items-center gap-2">
              ...
              <div>
                ...
                <p className="text-[11px] text-muted">All changes up to date</p>
              </div>
            </div>
        ...
        <div className="grid gap-2.5">
          <div className="flex items-center justify-between rounded-[1.5rem] border border-border/70 bg-background/85 px-3.5 py-2.5">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.22em] text-primary">Dashboard</p>
              <h3 className="mt-1 text-base font-semibold tracking-tight">Today</h3>
            </div>
            <div className="flex items-center gap-2.5">
              <span className="hidden rounded-full border border-primary/15 bg-primary/5 px-2.5 py-1 text-[10px] font-medium text-primary sm:inline-flex">
                Branch 03
              </span>
              ...
              <div className="flex h-9 w-9 items-center justify-center rounded-full border border-border/70 bg-card/80 text-primary">
          ...
          <div className="grid gap-3 xl:grid-cols-[1.08fr_0.92fr]">
            <Card className="overflow-hidden p-3.5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  ...
                  <h3 className="mt-1 text-base font-semibold">Revenue trend</h3>
                </div>
                <TrendingUp className="h-4 w-4 text-primary" aria-hidden="true" />
              </div>

              <div className="mt-3.5 grid h-32 grid-cols-7 items-end gap-2 rounded-[1.5rem] border border-border/60 bg-background/70 p-3">
                ...
                {transactions.map((transaction, index) => (
                  ...
                  >
                    ...
                    <div className="text-right">
                      <p className="text-[13px] font-semibold">{siteConfig.defaultCurrency} {transaction.amount}</p>
            ...
            <div className="grid gap-3">
              <Card className="p-3.5">
                <div className="flex items-center justify-between gap-3">
                  <div>
                    ...
                    <h3 className="mt-1 text-sm font-semibold">Search products</h3>
                  </div>
                  <ShoppingCart className="h-4 w-4 text-primary" aria-hidden="true" />
                </div>

                <div className="mt-3.5 rounded-[1.5rem] border border-border/70 bg-background/70 p-2.5">
              ...
              <Card className="p-3.5">
                ...
                <div className="mt-3.5 rounded-3xl border border-primary/15 bg-[linear-gradient(135deg,rgba(59,130,246,0.08),rgba(34,211,238,0.12))] p-3.5">
